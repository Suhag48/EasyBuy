...
const About = () => {
  ...
  return (
    <section className="px-4 py-16 md:py-24 md:px-12 lg:px-16 text-gray-700">
      <div className=" flex flex-col gap-16 lg:gap-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 min-h-[340px] w-full">
        ...
        <div className="grid md:grid-cols-2 gap-6 min-h-[340px] w-full" id="story">
          <div>
